...
class NeedListModel {
    ...
    public function create(string $category, string $item, string $type, int $user_id): bool {
    ...
    public function getPvp(int $user_id): array {
        $pdo = Database::getInstance();
    ...
    public function getPve(int $user_id): array {
        $pdo = Database::getInstance();
